...
- **Signal ID**: `sig_revolut_ultra_1787000345502`
...
**PM Triage Decision**:
- [ ] **APPROVE**: `npm run triage -- --approve sig_revolut_ultra_1787000345502`
- [ ] **REJECT / NOISE**: `npm run triage -- --reject sig_revolut_ultra_1787000345502`
